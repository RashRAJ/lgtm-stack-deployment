...
try:
    ...
    print(f"A required module is missing. Please ensure all dependencies are installed.")
    print(f"This typically involves a virtual environment. Steps:")
    print(f"1. Create a virtual environment (if you haven't already):")
    print(f"   python -m venv .venv")
    print(f"2. Activate the virtual environment:")
    print(f"   - On Linux/macOS: source .venv/bin/activate")
    print(f"   - On Windows (PowerShell): .\\.venv\\Scripts\\Activate.ps1")
    print(f"   - On Windows (CMD): .\\.venv\\Scripts\\activate.bat")
    print(f"3. Install the required packages (e.g., using uv or pip):")
    print(f"   uv pip install numpy matplotlib scipy statsd")
    print(f"   # OR, if not using uv:")
    print(f"   pip install numpy matplotlib scipy statsd")
    exit(9)
"""
